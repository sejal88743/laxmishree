...
export default function ReportPage() {
  ...
  const filteredRecords = useMemo(() => {
    return records
      ...
      .map(processRecord);
  }, [records, dateRange, machineFilter, shiftFilter]);
    ...
    return (
        <div className="mb-4 print-card">
            ...
            <Table className="text-xs print-table">
                ...
                <TFoot>
                    <TableRow>
                        <TableCell colSpan={3} className="font-bold">Total Weft Meter</TableCell>
                        <TableCell colSpan={2} className="font-bold">{totalWeft.toFixed(2)}</TableCell>
                    </TableRow>
                </TFoot>
            </Table>
        </div>
